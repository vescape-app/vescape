...
| Tune Profiles                                  | list/get/count; create; rename; save with history; rollback; copy; delete with history                                    | `tune-history-alert-close-reopen-rollback`, including retained patch/suffix keys, major/minor filtering, and last-compatible-profile protection                                                                                                                                               |
