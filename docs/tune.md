...
| Lighting                 | `LIGHTS_CONTROL` (20), `LCM_LIGHT_CTRL` (26)                                     | Two channels: `LIGHTS_CONTROL` switches Refloat's own lights and headlights (mask + value bits), while `LCM_LIGHT_CTRL` writes brightness levels to an external light module. Neither persists. See [refloatAlldata.md](./refloatAlldata.md). |
