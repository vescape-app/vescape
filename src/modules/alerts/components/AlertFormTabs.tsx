  ...
  return (
    <View style={styles.tabRow}>
      ...
      >
        <WaveformIcon
          size={14}
          color={tab === 'single' ? theme.palette.slate.textPrimary : theme.palette.slate.textMuted}
          weight="fill"
        />
      ...
      >
        <RadioactiveIcon
          size={14}
          color={tab === 'geiger' ? theme.palette.slate.textPrimary : theme.palette.slate.textMuted}
          weight="fill"
        />
      ...
      >
        <ChatTextIcon
          size={14}
          color={
            tab === 'message' ? theme.palette.slate.textPrimary : theme.palette.slate.textMuted
          }
          weight="fill"
        />
