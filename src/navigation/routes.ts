...
export const routes = {
  ...
  accessories: '/accessories' as Href,
  accessoryScan: '/accessories/scan',
  accessory: '/accessories/[accessoryId]',
  accessoryGroundClearance: '/accessories/ground-clearance',
  accessoryBrakeLight: '/accessories/brake-light',
